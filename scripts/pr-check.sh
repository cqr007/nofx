...
if ! git remote | grep -q "^upstream$"; then
    ...
    log_command "git remote add upstream https://github.com/nofxai/nofx.git"
    echo ""
fi
...
echo "  ✅ Bug fixes"
echo ""
log_suggestion "Check roadmap: https://github.com/nofxai/nofx/blob/dev/docs/roadmap/README.md"
echo ""
...
echo ""
echo "📚 Resources:"
echo "  - Contributing Guide: https://github.com/nofxai/nofx/blob/dev/CONTRIBUTING.md"
echo "  - Migration Guide: https://github.com/nofxai/nofx/blob/dev/docs/community/MIGRATION_ANNOUNCEMENT.md"
echo ""
