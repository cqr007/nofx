...
See [Issue #202](https://github.com/nofxai/nofx/issues/202) and [Troubleshooting Guide](TROUBLESHOOTING.md#-only-opening-short-positions-issue-202).
...
2. Search [existing issues](https://github.com/nofxai/nofx/issues)
3. If not found, use our [Bug Report Template](../../.github/ISSUE_TEMPLATE/bug_report.md)

### Where can I get help?
- [GitHub Discussions](https://github.com/nofxai/nofx/discussions)
- [Telegram Community](https://t.me/nofx_dev_community)
- [GitHub Issues](https://github.com/nofxai/nofx/issues)
...
Open a [Feature Request](https://github.com/nofxai/nofx/issues/new/choose) with your idea!
