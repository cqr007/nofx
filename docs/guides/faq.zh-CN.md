...
参见 [Issue #202](https://github.com/nofxai/nofx/issues/202) 和[故障排查指南](TROUBLESHOOTING.zh-CN.md#-只开空单-issue-202)。
...
2. 搜索[现有 Issues](https://github.com/nofxai/nofx/issues)
...
### 如何建议新功能？
提交 [Feature Request](https://github.com/nofxai/nofx/issues/new/choose) 说明您的想法！
